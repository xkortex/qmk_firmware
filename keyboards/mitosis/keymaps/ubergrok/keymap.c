...
const uint16_t PROGMEM keymaps[7][MATRIX_ROWS][MATRIX_COLS] = {
  [_xQ] = LAYOUT(
      ...
      /*,      */ KC_HENK, LM(_xQ,KC_LCTL), MO(_xN), LSFT_T(KC_TAB), KC_SPC,  MO(_xS), KC_RALT, KC_MHEN),
  [_xC] = LAYOUT(
      KC_Q,    KC_W,       KC_F,    KC_P,    KC_G,           KC_J,    KC_L,    KC_U,    KC_Y,     KC_SCLN,
      KC_A,    KC_R,       KC_S,    KC_T,    KC_D,           KC_H,    KC_N,    KC_E,    KC_I,     KC_O,
      KC_Z,    KC_X,       KC_C,    KC_V,    KC_B,           KC_K,    KC_M,    KC_COMM, KC_DOT,   KC_QUOT,
      /*,      */ _______, _______, _______, _______,        _______, _______, _______, _______,
      /*,      */ _______, LM(_xQ,KC_LCTL), _______, _______,        _______, _______, _______, _______),
  [_xD] = LAYOUT(
  ...
  [_xW] = LAYOUT(
      ...
      /*,      */ _______, LM(_xQ,KC_LCTL), _______, _______,        _______, _______, _______, _______),
  [_xS] = LAYOUT(
      KC_ESC,  KC_END ,    KC_UP,   KC_HOME, KC_PGUP,        KC_PLUS, KC_CIRC, KC_AMPR, KC_PERC,  KC_MINS,
      ...
      /*,      */ _______, LM(_xQ,KC_LCTL), TT(_xF), _______,        _______, TT(_xF), _______, _______),
  [_xN] = LAYOUT(
      KC_PSCR, KC_F7,      KC_F8,   KC_F9,   KC_F10,         KC_PPLS, KC_7,    KC_8,    KC_9,     KC_KP_DOT,
